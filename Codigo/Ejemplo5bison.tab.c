...
#line 19 "Ejemplo5bison.y"
                       { printf("= %d\n", yyvsp[-1]); }
#line 1076 "Ejemplo5bison.tab.c"
    break;

  case 5: /* exp: exp ADD factor  */
#line 24 "Ejemplo5bison.y"
                     { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1082 "Ejemplo5bison.tab.c"
    break;

  case 6: /* exp: exp SUB factor  */
#line 25 "Ejemplo5bison.y"
                     { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1088 "Ejemplo5bison.tab.c"
    break;

  case 8: /* factor: factor MUL term  */
#line 30 "Ejemplo5bison.y"
                      { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1094 "Ejemplo5bison.tab.c"
    break;

  case 9: /* factor: factor DIV term  */
#line 31 "Ejemplo5bison.y"
                      { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1100 "Ejemplo5bison.tab.c"
    break;

  case 11: /* term: ABS term  */
#line 36 "Ejemplo5bison.y"
               { yyval = (yyvsp[0] >= 0) ? yyvsp[0] : -yyvsp[0]; }
#line 1106 "Ejemplo5bison.tab.c"
    break;


#line 1110 "Ejemplo5bison.tab.c"
